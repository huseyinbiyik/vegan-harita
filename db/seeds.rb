...
#
50.times do
  Post.create!(title: Faker::Lorem.sentence, content: Faker::Lorem.paragraph_by_chars(number: 256, supplemental: false), user: User.first, post_topic: PostTopic.first)
end
