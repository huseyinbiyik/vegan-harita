...
Rails.application.configure do
  ...
  Rails.application.routes.default_url_options[:host] = Rails.application.credentials.dig(:aws, :cloudfront_url)
  ...
  # config.active_job.queue_name_prefix = "vh_api_production"
